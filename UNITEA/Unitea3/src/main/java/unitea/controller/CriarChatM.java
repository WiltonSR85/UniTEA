...
public class CriarChatM extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(pedido.getChat().getIdPedidoMonitoriaAssociado()+" cabaço");
		
		request.getRequestDispatcher("ChatMonitor.jsp").forward(request, response);
