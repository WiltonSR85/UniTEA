...
<body>
    ...
    <header>
        ...
        <nav>
        	<ul>
                ...
                <li><a href="telaMentor.jsp" id="pedidosMonitor">Pedidos em Andamento</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <% 
                List<PedidoMonitoriaModel> pedidos = (List<PedidoMonitoriaModel>) session.getAttribute("pedidos3");
                if (pedidos != null) {
                    for (PedidoMonitoriaModel pedido : pedidos) {
                    	System.out.println("bom dia narilene" + pedido.getDisciplina());
                %>
                <tr>
                    ...
                    <td>
                        <form action="chatMonitor" method="get" style="display:inline;">
    ...
    <div>
           <form action="telaInicialM" method="post" style="display: inline;">
