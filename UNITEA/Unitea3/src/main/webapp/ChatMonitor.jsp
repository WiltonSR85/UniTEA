        ...
        <div class="content">
            <div class="chat-box">
                ...
                <div class="chat-messages">
                    ...
                    %>
                        <div class="mensagem">
                            <strong style="color: blue;">Usuário <%= mensagem.getIdUsuario() %>:</strong>
                ...
                <div class="chat-input">
                    <form action="comentarMonitor" method="get">
                        <input type="hidden" name="idChat" value="<%= pedido != null && pedido.getChat() != null ? pedido.getChat().getIdChat() : "" %>">
                        <input type="hidden" name="usuario" value="<%= session.getAttribute("id_usuarioMonitor") != null ? session.getAttribute("id_usuarioMonitor") : "" %>">
